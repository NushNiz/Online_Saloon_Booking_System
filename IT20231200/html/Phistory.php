	...
	<body class="bg">
			<div class="box-area">
				<header><!----------------- HEADER ----------------------->
					...
					<div class="con">
						<div class="wrapper">
							<h2 id="center">Welcome to My Account</h2><br>
					</div>
			...
			<div class="box">
	<div class="innerbox">
		<h1><b><u><center>MY ACCOUNT</center></u></b></h1>
		<br><br><br><br>
		<br>
		<center>
			<button type="button" id="btn2">Search My Purchase History</button><br><br><br><br><br><br>
