	...
	<body class="bg">
			<div class="box-area">
				<header><!----------------- HEADER ----------------------->
					<div class="wrapper">
						<div class="logo">
							...
							<nav>
								...
								<a href="../../IT20231200/html/Feedback%20Page.html">Review</a>
					...
					<div class="con">
						<div class="wrapper">
							<h2 id="center">Administrator LOGIN</h2><br>
					</div>
					...
					<!---------------------- CONTENT ----------------------------->
                        ...
                        <div class="cc">
                        	<img class="logg"src="../images/login.png">
                    		...
                    		<div class="in">
                        		...
                        		<br><br><br><button name="button" class="btnn1">LOGIN</button>
